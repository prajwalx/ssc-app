// Generated on 2017-12-18 using generator-angular-fullstack 3.7.6
'use strict';
...
gulp.task('serve', cb => {
    runSequence(['clean:tmp', 'constant', 'env:all','inject:css'],
        ['lint:scripts', 'inject'],
        ['wiredep:client'],
...
gulp.task('constant', function() {
  ...
  return plugins.ngConstant({
    name: 'sscTestSeriesApp.constants',
    deps: [],
    wrap: true,
    stream: true,
